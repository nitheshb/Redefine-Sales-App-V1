...
class NotInterestedLeadQuestionsScreen extends StatefulWidget {
  @override
  _NotInterestedLeadQuestionsScreenState createState() => _NotInterestedLeadQuestionsScreenState();
}

class _NotInterestedLeadQuestionsScreenState extends State<NotInterestedLeadQuestionsScreen> {
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
                          FxText.bodyLarge("Why Lead is not interested",
                              color: theme.colorScheme.onBackground,
                              fontWeight: 600),
                          Container(
                            margin: FxSpacing.top(2),
                            child: FxText.bodySmall("1 Questions",
                                color: theme.colorScheme.onBackground,
                                fontWeight: 500,
                                muted: true),
                          ),
              ...
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    SingleQuestion(
                      qNumber: 1,
                      question: "Why Lead is not interested",
                      options: const [
                        "Budget issue",
                        "Looking for different area & property",
                        "Looking for different area",
                        "Looking for different property"
                      ],
                    ),
