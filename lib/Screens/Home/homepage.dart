                                  ...
                                  () => Padding(
                                    ...
                                    child: ActionChip(
                                        ...
                                        backgroundColor: controller
                                            ...
                                            : Colors.transparent,
                                        label: FxText.bodySmall(
                                          "All Tasks  ${controller.myTaskTypeCategory == 'allBusinessTasks' ? controller.totalTasksStreamData.value.length : ""}",
                                          fontSize: 11,
                                          fontWeight: 700,
                                    ...
                                    child: InkWell(
                                      ...
                                      child: ActionChip(
                                          ...
                                          backgroundColor: controller
                                              ...
                                              : Colors.transparent,
                                          label: FxText.bodySmall(
                                            "Assigned to me   ${controller.myTaskTypeCategory == 'assignedToMe' ? controller.totalTasksStreamData.value.length : ""}",
                                            fontSize: 11,
                                            fontWeight: 700,
                                            color: controller.myTaskTypeCategory
                                                        .value ==
                                    ...
                                    child: ActionChip(
                                        ...
                                        backgroundColor:
                                            controller.myTaskTypeCategory ==
                                                ...
                                                : Colors.transparent,
                                        label: FxText.bodySmall(
                                          "Created by me  ${controller.myTaskTypeCategory == 'creatdByMe' ? controller.totalTasksStreamData.value.length : ""}",
                                          fontSize: 11,
                                          fontWeight: 700,
                                          color:
                                              controller.myTaskTypeCategory ==
                                    ...
                                    child: ActionChip(
                                        ...
                                        backgroundColor:
                                            controller.myTaskTypeCategory ==
                                                ...
                                                : Colors.transparent,
                                        label: FxText.bodySmall(
                                          "Participants ${controller.myTaskTypeCategory == 'participants' ? controller.totalTasksStreamData.value.length : ""}",
                                          fontSize: 11,
                                          fontWeight: 700,
                                          color:
                                              controller.myTaskTypeCategory ==
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (snapshot.hasError) {
                      ...
                      if (!controller.businessMode.value) {
                        ...
                        controller.businessData.value = TotalTasks.where(
                            (element) =>
                                (element["by_uid"] != element["to_uid"]) &&
                                (element["by_uid"] ==
                                        FirebaseAuth
                        ...
                        controller.personalData.value = TotalTasks.where(
                            (element) =>
                                element["by_uid"] ==
                                ...
                                child: MediaQuery.removePadding(
                                  ...
                                  child: Padding(
                                    ...
                                    child: ListView.builder(
                                        ...
                                        physics: const BouncingScrollPhysics(),
                                        itemCount: controller
                                            .totalTasksStreamData.length,
                                        itemBuilder: (context, index) {
                                          late QueryDocumentSnapshot<Object?>?
                                              taskData = controller
                                                  .totalTasksStreamData[index];
